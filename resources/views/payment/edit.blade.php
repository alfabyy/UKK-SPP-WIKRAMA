    ...
    <div class="m-2">
        ...
        <form action="{{ route('payment.update', $payment->id) }}" method="POST">
            ...
            <div class="input-group mt-2 mb-2">
                ...
                <input type="text" class="form-control" value="{{ $payment->nisn }}" disabled required>
            ...
            <div class="input-group mt-2 mb-2">
                ...
                <input type="text" class="form-control" value="{{ $payment->id_spp }}" id="spp" disabled required>
            </div>
            ...
            <div class="input-group mb-2" id="terakhir_bayar">
                ...
                <input type="text" id="lastm" value="{{ $payment->bulan_dibayar }} - {{ $payment->tahun_dibayar }}" class="form-control" readonly name="terakhir_bayar" >
            </div>
            ...
            <div class="input-group mb-2" id="total_bayar">
                ...
                <input type="text" id="byr" value="{{ $payment->jumlah_bayar }}" class="form-control" disabled name="total_bayar" required>
            </div>
            <div class="input-group mb-2" id="total_bayar">
                <div class="input-group-prepend">
                    <span for="total_bayar" class="input-group-text">Bayar</span>
                </div>
                <input type="text" id="bayar-spp" value="{{ $payment->jumlah_bayar }}" class="form-control" name="jumlah_bayar" required>
            </div>
